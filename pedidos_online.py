...
async def process_order(order_id, items):
    ...
    inventory_results = await asyncio.gather(*inventory_checks) # Esperar a que todas las verificaciones de inventario se completen lanza todas las tareas concurrentemente
